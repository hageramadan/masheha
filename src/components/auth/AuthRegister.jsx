...
export default function AuthRegister({ onSwitchToLogin, onOtpSent }) {
  ...
  const handleSubmit = (e) => {
    ...
    onOtpSent(phoneNumber, countryCode, 'register');
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">يرجى إدخال رقم الهاتف لإنشاء حساب</p>
      </div>
